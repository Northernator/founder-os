...
export const MODEL_PRICING: ModelPricing[] = [
  ...
  { provider: "anthropic", model: "claude-opus-4-6", inputPerMillionTokens: 15, outputPerMillionTokens: 75 },
  { provider: "anthropic", model: "claude-sonnet-4-6", inputPerMillionTokens: 3, outputPerMillionTokens: 15 },
  { provider: "anthropic", model: "claude-haiku-4-5-20251001", inputPerMillionTokens: 1, outputPerMillionTokens: 5 },

  // OpenAI — https://openai.com/api/pricing/
  { provider: "openai", model: "gpt-4o", inputPerMillionTokens: 2.5, outputPerMillionTokens: 10 },
  { provider: "openai", model: "gpt-4o-mini", inputPerMillionTokens: 0.15, outputPerMillionTokens: 0.6 },
  { provider: "openai", model: "gpt-4-turbo", inputPerMillionTokens: 10, outputPerMillionTokens: 30 },
  ...
  { provider: "gemini", model: "gemini-2.5-pro", inputPerMillionTokens: 1.25, outputPerMillionTokens: 10 },
  { provider: "gemini", model: "gemini-2.5-flash", inputPerMillionTokens: 0.3, outputPerMillionTokens: 2.5 },
  { provider: "gemini", model: "gemini-2.0-flash", inputPerMillionTokens: 0.1, outputPerMillionTokens: 0.4 },
  { provider: "gemini", model: "gemini-1.5-pro", inputPerMillionTokens: 1.25, outputPerMillionTokens: 5 },
  { provider: "gemini", model: "gemini-1.5-flash", inputPerMillionTokens: 0.075, outputPerMillionTokens: 0.3 },

  // DeepSeek — https://api-docs.deepseek.com/quick_start/pricing
  { provider: "deepseek", model: "deepseek-chat", inputPerMillionTokens: 0.27, outputPerMillionTokens: 1.1 },
  { provider: "deepseek", model: "deepseek-reasoner", inputPerMillionTokens: 0.55, outputPerMillionTokens: 2.19 },

  // xAI Grok — https://docs.x.ai/docs/models
  { provider: "grok", model: "grok-3", inputPerMillionTokens: 3, outputPerMillionTokens: 15 },
  { provider: "grok", model: "grok-3-mini", inputPerMillionTokens: 0.3, outputPerMillionTokens: 0.5 },
  ...
  { provider: "kimi", model: "kimi-k2-0711-preview", inputPerMillionTokens: 0.6, outputPerMillionTokens: 2.5 },
  { provider: "kimi", model: "moonshot-v1-128k", inputPerMillionTokens: 8.4, outputPerMillionTokens: 8.4 },
  { provider: "kimi", model: "moonshot-v1-32k", inputPerMillionTokens: 3.5, outputPerMillionTokens: 3.5 },
  { provider: "kimi", model: "moonshot-v1-8k", inputPerMillionTokens: 1.7, outputPerMillionTokens: 1.7 },

  // Perplexity — https://docs.perplexity.ai/guides/pricing
  { provider: "perplexity", model: "sonar-pro", inputPerMillionTokens: 3, outputPerMillionTokens: 15 },
  { provider: "perplexity", model: "sonar", inputPerMillionTokens: 1, outputPerMillionTokens: 1 },
  { provider: "perplexity", model: "sonar-reasoning-pro", inputPerMillionTokens: 2, outputPerMillionTokens: 8 },
  { provider: "perplexity", model: "sonar-reasoning", inputPerMillionTokens: 1, outputPerMillionTokens: 5 },

  // Ollama — local, self-hosted. No marginal token cost.
  { provider: "ollama", model: "llama3.1:70b", inputPerMillionTokens: 0, outputPerMillionTokens: 0 },
 ...
 */
export function getPricing(provider: string | undefined | null, model: string | undefined | null): ModelPricing {
